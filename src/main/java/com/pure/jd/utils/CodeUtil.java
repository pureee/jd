...
public class CodeUtil {
     ...
     * @return
     */
    public static String get(final int num) {
     ...
     * @param response
     */
    public static void getVerifyCodeImg(HttpServletRequest request, HttpServletResponse response) {
        try {
        // 响应头信息
        ...
        // 保存生成的5位验证码
        request.getSession().setAttribute(Const.VERIFY_CODE_IMG, vCode);

        // 验证码图片的生成
        // 定义图片的宽度和高度
        int width = (int) Math.ceil(size * 23);
        int height = 50;
    ...
    private static Font randomFont() {
        ...
        int size = r.nextInt(3) + 27; // 生成随机字号 26,30
